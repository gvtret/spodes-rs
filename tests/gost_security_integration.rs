...
fn test_gost3410_vko_key_agreement() {
    ...
    let pk = gost3410::public_key(&sk).unwrap();
    let ukm = [0xF0, 0xF0, 0xF0, 0xF0, 0xE1, 0xE1, 0xE1, 0xE1,
...
fn test_gost_kdf_tree() {
    let key = [
        0x4F, 0x54, 0xF6, 0x63, 0x02, 0x97, 0x09, 0xC0,
        0x27, 0x1F, 0xAC, 0xD5, 0xBB, 0x6D, 0x58, 0x18,
        0x74, 0x10, 0x47, 0x7E, 0x10, 0x25, 0x55, 0xA8,
        0x93, 0xD4, 0x5A, 0x04, 0xAB, 0x0C, 0xAF, 0xC0,
    ];
